import { CLIENT_VERSION, DEFAULT_URL, LAST_VIEW_STORAGE_KEY, SEARCH_HISTORY_STORAGE_KEY, STORAGE_KEY, THEME_STORAGE_KEY } from "./js/config.js?v=20260731-novel-shelf-ui-52";
import { fetchJson } from "./js/api.js?v=20260706-mobile-web-sync-01";
import { cacheAgeText, clearCachedData, getCacheStats, readCachedJson, writeCachedJson } from "./js/cache.js?v=20260731-novel-shelf-ui-52";
...
import { getElements } from "./js/dom.js?v=20260731-novel-shelf-ui-52";
