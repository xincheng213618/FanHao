...
本项目会以只读方式扫描 `G:\`、`F:\`、`O:\`、`O:\[珍藏]\`、`O:\[珍藏1]\`、`V:\[A]\`、`V:\[A1]\`、`V:\AV\`，按顶层文件夹作为人物分类，在局域网内提供网页浏览。
...
- 服务端口：`29998`
- 监听地址：`0.0.0.0`
- 资料库路径：`G:\`、`F:\`、`O:\`、`O:\[珍藏]\`、`O:\[珍藏1]\`、`V:\[A]\`、`V:\[A1]\`、`V:\AV\`
- `[A]` 会作为一个特殊人物分类
- 作品标题优先使用文件夹名
...
```powershell
$env:LIBRARY_ROOTS = "G:\;F:\;O:\;O:\[珍藏]\;O:\[珍藏1]\;V:\[A]\;V:\[A1]\;V:\AV\"
$env:PORT = "29998"
$env:HOST = "0.0.0.0"
npm start
```
