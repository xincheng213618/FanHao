...
export function railButton(label, icon, kind = "", ariaLabel = "", action = null) {
...
function iconMarkup(name) {
  ...
  const icons = shortVideoIconMarkupTable || (shortVideoIconMarkupTable = {
    ...
    download: `<svg viewBox="0 0 24 24" aria-hidden="true"><path ${line} d="M12 3v12M7 10l5 5 5-5M4 20h16"/></svg>`,
    folder: `<svg viewBox="0 0 24 24" aria-hidden="true"><path ${line} d="M3 7V5a2 2 0 0 1 2-2h5l2 3h7a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V7z"/></svg>`,
