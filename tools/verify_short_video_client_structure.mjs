...
assert(androidNativePlayerSource.split(/\r?\n/).length <= 5750, "Android native short-video Activity exceeded its refactored 5750-line budget");
...
function verifyWebDedicatedEntry() {
  ...
  assert(playerSource.split(/\r?\n/).length <= 6850, "the Web short-video composition root must stay below 6850 lines");
