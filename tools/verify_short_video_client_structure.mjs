...
assert(androidEntrySource.includes("./index.js?v=20260812-native-action-ui-01") && androidEntrySource.includes("discardPushedView: host.navigation.discardPushedView") && androidIndexSource.includes("./collections/controller.js?v=20260812-collection-management-03"), "Android collection management and native action UI changes must propagate through the JavaScript module cache-version chain");
